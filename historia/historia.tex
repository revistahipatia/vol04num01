...
O computador ENIAC - Electronic Numerical Integrator and Computer (1945), construído a partir de um projeto financiado pelo Laboratório de Pesquisas do Exército Americano, era uma máquina de 30 toneladas, com mais de 17 mil válvulas. Foi a primeira máquina programável \emph{Turing completa}, ou seja, capaz de simular qualquer máquina de Turing, o que significava ter capacidade de executar algoritmos equivalentes à máquina universal de Turing.
...
As vantagens dos transistores em relação às válvulas: não precisam de aquecimento, baixo consumo de energia, durabilidade e maior confiabilidade, tamanho pequeno e rapidez; transformaram a história do computador e da sociedade.
...
A invenção de uma \textit{linguagem para estruturar páginas}, \verb|HTML| ; do \textit{endereçamento de um recurso}, \verb|www. .com| ; do \textit{protocolo para solicitar páginas}, \verb|HTTP|, tornaram a internet acessível à sociedade em geral, não mais ficando restrita a centros de pesquisas e universidades com usuários com o conhecimento técnico necessário para lidar com comandos e códigos, e com conhecimento científico para entender, ou ao menos saber, quais teorias científicas estão envolvidas na invenção. O \textit{link} funciona como o botão da máquina fotográfica portátil, lançada pela KODAK cerca de 100 anos antes, afastando o conhecimento científico dos usuários dos aparelhos.
...
A empresa holandesa ASML - Advanced Semiconductor Materials Lithography (1984) é a única fábrica do mundo que produz as \textit{máquinas de litografia} mais avançadas  usadas na fabricação de chips. Utiliza óptica alemã, laser americano, chips japoneses e engenharia holandesa. Empresas como TSMC - Taiwan Semiconductor Manufacturing Co (Taiwan, 1987), Samsung Electronics (Coréia do Sul) e Intel usam as máquinas da ASML para produzir os chips mais avançados. NVIDIA (1993), AMD - Advanced Micro Devices (1969) e Intel, empresas americanas, são líderes no projeto de novos chips.
