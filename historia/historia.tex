...
Ainda não existe consenso entre os historiadores sobre qual evento marca a transição entre os séculos XX e XXI.
	...
	Em 2022, a primeira versão do ChatGPT, acessível ao público em geral, foi disponibilizada pela empresa americana OpenAI (2015). Segundo o ChatGPT 5.5 \cite{OpenAI2026}, versão do programa/sistema que consulto ao escrever esse texto:
