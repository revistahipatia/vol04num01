...
\begin{figure}[htb!]
\begin{center}
\includegraphics[width=7cm]{transistor.jpeg}
\caption{Réplica do Primeiro Transistor, Bell Labs, 1947.}
\end{center}
\end{figure}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[width=7cm]{camerakodak.jpeg}
\caption{Primeira Câmera Digital, Kodak, 1975.}
\end{center}
\end{figure}
...
A História segue. E os artistas e os cientistas, seguidores de Galileu, continuarão a dizer \textit{``E pur si muove.''}.
